...
Mikäli kirjasto ei aukea varmista, että olet Shellyn asetusliittymässä wifi-verkon ip-osoitteen kautta. Shellyn tukiaseman kautta käytettäessä (osoitteesta 192.168.33.1) skriptikirjasto ei välttämättä lataudu oikein.
{% endhint %}
